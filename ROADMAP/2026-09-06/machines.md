...
| # | Machine | Memory for weights | ~Bandwidth | Ceiling at Q4 | Status as of 2026-09-06 |
| --- | --- | --- | --- | --- | --- |
...
Unchanged from [the 2026-09-05 revision](../2026-09-05/machines.md), which was
unchanged from the one before it: no machine
