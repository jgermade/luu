...
**What changed in this revision:** nothing in the inventory, and that is the
news. No box moved, no ceiling was measured and no machine was reached between
2026-09-08 and this file — the night's work was all UI, sandbox and window, none
of which needs a model. What changed is on the other side: **machines 1 and 4 are
now the only thing standing between this project and its cheapest unbought
answer**, which is one afternoon of `--repeat-once` against a 7B. The file is
...
1. **The BC-250's 14B ceiling** — roadmap item 10, deferred from
...
2. **A judge that is not the model under test** (P1) — roadmap item 9. Not a
   ...
   tool-call probe of item 3 is the first whose scoring is four-way and per
   reply.
