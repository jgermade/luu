...
| 11 | ~**What a container start costs** — *the worker starts with the session* was chosen on the shape of the thing and not on a number, and the `container` job already makes the same call on both sides~ **already closed when this revision was cut, and carried in error.** Measured 2026-09-15 on machine 1 — ~100 ms over a host session, warm — on a branch that landed at 20:24 on 2026-09-21, two hours *after* this file, and struck its row only in [`ROADMAP/2026-09-09`](../2026-09-09/README.md), the revision it had been written against. [`ROADMAP/2026-09-17`](../2026-09-17/README.md) carried it the same way. Found cutting [`ROADMAP/2026-09-23`](../2026-09-23/README.md) | nothing | [`what-a-container-start-costs`](../../RECORD/2026-09-15.what-a-container-start-costs.completed.md), from [`a-session-picks-its-executor`](../../RECORD/2026-09-08.a-session-picks-its-executor.completed.md) §Still open |
